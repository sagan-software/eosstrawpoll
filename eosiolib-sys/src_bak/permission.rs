use super::types::{AccountName, PermissionName};
...
extern "C" {
     ...
     */
    pub fn get_permission_last_used(account: AccountName, permission: PermissionName) -> i64;
     ...
     */
    pub fn get_account_creation_time(account: AccountName) -> i64;
