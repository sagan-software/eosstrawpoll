...
class eosstrawpoll_tester : public TESTER
{
  ...
  public:
    ...
    eosstrawpoll_tester(Lambda setup)
    {
        ...
        create_account_with_resources(N(eosstrawpoll), config::system_account_name, core_from_string("100.0000"), false);
        set_code(N(eosstrawpoll), contracts::wasm());
        set_abi(N(eosstrawpoll), contracts::abi().data());
        {
    ...
    transaction_trace_ptr create_account_with_resources(account_name a, account_name creator, uint32_t ram_bytes = 8000)
    {
        ...
        trx.actions.emplace_back(get_action(config::system_account_name, N(delegatebw), vector<permission_level>{{creator, config::active_name}},
                                            mvo()("from", creator)("receiver", a)("stake_net_quantity", core_from_string("10.0000"))("stake_cpu_quantity", core_from_string("10.0000"))("transfer", 0)));
    ...
    uint32_t now() const
    {
        return time_point_sec(control->pending_block_time()).sec_since_epoch();
    }
    ...
    void cross_15_percent_threshold()
    {
        ...
        regproducer(N(producer1111));
        {
            ...
            trx.actions.emplace_back(get_action(config::system_account_name, N(delegatebw),
                                                ...
                                                mvo()("from", name{config::system_account_name})("receiver", "producer1111")("stake_net_quantity", core_from_string("150000000.0000"))("stake_cpu_quantity", core_from_string("0.0000"))("transfer", 1)));
            ...
            trx.actions.emplace_back(get_action(config::system_account_name, N(undelegatebw),
                                                vector<permission_level>{{N(producer1111), config::active_name}},
                                                mvo()("from", "producer1111")("receiver", "producer1111")("unstake_net_quantity", core_from_string("150000000.0000"))("unstake_cpu_quantity", core_from_string("0.0000"))));
