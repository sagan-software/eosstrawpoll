    ...
    ($($t:ty)*) => ($(
        impl Renderable<$t> for $t {
            fn view(&self) -> Html<Self> {
                crate::seo::set_title(&self.get_title());
                crate::seo::set_description(&self.get_description());
                crate::seo::set_url(&self.get_route().to_absolute());
                ...
                let breadcrumbs_view = if breadcrumbs.is_empty() {
                    ...
                    crate::views::breadcrumbs::view(breadcrumbs, &self.get_title())
                };
                html! {
                    <div class=class, >
