use crate::eos::types::*;
use crate::scatter::{ScatterNetwork, ScatterRequiredFields};
use eosio::{n, s, AccountName, Symbol};
...
pub fn eos_devnet() -> Chain {
    Chain {
        ...
        eosio_token_account: n!(eosio.token).into(),
        core_symbol: s!(4, SYS).into(),
        endpoint: Endpoint {
